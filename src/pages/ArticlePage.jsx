  ...
  return (
    <div className="landing-container bg-white min-h-screen font-inter">
      ...
      <div className="flex flex-row justify-center w-full" id="article-div">
        <div className="flex flex-col px-4">
          ...
          <div className="max-w-4xl text-lg flex flex-col gap-3">
            ...
            <p className="m-0 bg-[#274764] text-white px-3 py-2 rounded-2xl w-fit text-sm">
          ...
          <div className="fixed bottom-10 right-10 z-50">
            <button
              onClick={scrollToTop}
              className="bg-[#274764] text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg">
              ↑
            </button>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 flex justify-center">
        <button
          className="bg-[#11355b] hover:bg-[#524439] text-white px-4 py-2 rounded-md text-lg font-medium flex items-center justify-center gap-3 max-w-xs"
          onClick={downloadPdf}
        >
      ...
      >
        ...
        <div className="relative z-10 pl-10 p-4 rounded-md">
          ...
          <div className="upload-file flex justify-start">
            ...
            >
              <p className="text-xl sm:text-2xl md:text-[30px] mb-0.5 font-[100] tracking-[0.06em] text-left mt-3">
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              {isConsentChecked && (
                <button
                  ...
                  className="mt-4 bg-[#11355b] hover:bg-[#524439] text-white px-4 py-2 rounded-md text-lg font-medium flex items-center justify-center gap-3 max-w-xs"
                >
